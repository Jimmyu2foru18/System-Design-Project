            ...
            <div class="bg-blue-600 text-xl text-white">
                <div class="container mx-auto px-4">
                    <div class="flex justify-between items-center h-12">
						...
						<button class="text-black hover:text-gray-800">Account</button>
							<div class="absolute left-0 top-full min-w-max bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:flex flex-col transition-opacity duration-200 z-50">
								<a href="profile.html" class="block px-4 py-2 text-black hover:bg-gray-300">Profile</a>
								<a href="recipe-create.html" class="block px-4 py-2 text-black hover:bg-gray-300">Create Recipe</a>
								<a href="#" class="block px-4 py-2 text-black hover:bg-gray-300" data-action="sign-out">Sign Out</a>
							</div>
						</div>
                    </div>					
                </div>
